      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 rounded-lg p-6">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>
              • <strong>Slow Mode:</strong> Visit the home page to see Suspense
              streaming in time-lapse
            </li>
            <li>
              • <strong>Error Mode:</strong> Try adding items to cart to test
              error boundaries
            </li>
            <li>
              • <strong>Server Components:</strong> View page source to see
              server-rendered HTML
            </li>
            <li>
              • <strong>Optimistic Updates:</strong> Star/favorite products for
              instant feedback
            </li>
            <li>
              • <strong>Form Actions:</strong> Update your profile or add items
              to cart
            </li>
          </ul>
        </div>
