...
class MockDatabase {
  ...
  private seedData() {
    ...
    this.products = [
      ...
      },
      {
        ...
        stock: 15,
        description:
          "Advanced fitness tracking with comprehensive health monitoring and GPS capabilities.",
      ...
      },
      {
        ...
        stock: 8,
        description:
          "Professional mechanical keyboard with RGB backlighting and premium switches.",
      ...
      },
      {
        ...
        stock: 5,
        description:
          "Stunning 4K monitor with wide color gamut and professional-grade color accuracy.",
      ...
      },
      {
        ...
        stock: 15,
        description:
          "Premium USB-C hub with multiple ports for laptops and tablets, featuring 4K HDMI output and fast charging.",
      ...
      },
      {
        ...
        stock: 18,
        description:
          "Fast wireless charging pad with LED indicator and universal Qi compatibility.",
      ...
      },
      {
        ...
        stock: 12,
        description:
          "Modern LED desk lamp with adjustable brightness and color temperature, featuring touch controls and USB charging port.",
  ...
  async getRecommendedProducts(userId: string): Promise<Product[]> {
    ...
    return this.products
      .filter((p) =>
        user.preferences.favoriteCategories.some((cat) => p.tags.includes(cat))
      )
      .slice(0, 4);
  }
  ...
  async removeFromStarred(userId: string, productId: string): Promise<boolean> {
    ...
    user.starredProducts = user.starredProducts.filter(
      (id) => id !== productId
    );
    return true;
  }
